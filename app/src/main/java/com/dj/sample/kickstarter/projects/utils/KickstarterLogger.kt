...
/**
 * Universal logger for  the application, we can extend this for Unit tests as well if we get to know
 * its if we are running in test mode.
 * @author Shashi Create on 18/07/2019
 */

object KickstarterLogger {
